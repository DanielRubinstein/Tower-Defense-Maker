...
public class BaseCheckerEngine implements Engine {
	...
	public void gameLoop(GameData gameData, double stepTime) {
		...
		for (Component c : myState.getComponentGraph().getAllComponents()) {
			...
			if (currentTile != null && ((boolean) currentTile.getAttribute("GoalTile").getValue()) && c.getAttribute(STRING_RESOURCES.getFromAttributeNames("Type")).getValue().equals(STRING_RESOURCES.getFromValueNames("EnemyType"))) {
